---
title: VS-10.0 Customer and Stakeholder Engagement — Business Layer
abstract: "This document describes the business layer of **VS-10.0 Customer and Stakeholder Engagement**, one of the four **supporting** value streams of the Statistical Architecture Framework (SAF). Unlike the primary streams (VS-01–VS-06), it does not transform data through steady states; it is a continuous, two-way dialogue that keeps the organization connected, relevant, and responsive to those it serves and those it relies on. VS-10 understands stakeholder needs, manages the service portfolio, delivers and supports services, communicates, and measures impact — feeding insight back into the whole chain. It is described here as a continuous capability (understand → offer → deliver → measure) rather than as a per-cycle data process."
